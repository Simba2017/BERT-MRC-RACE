...
def get_args(data_dir, output_dir, cache_dir, log_dir):
    ...
    parser.add_argument("--model_name", default="BertOrigin",
                        type=str, help="模型的名字")
    ...
    parser.add_argument("--article_length", type=int,
                        default=400, help="article 对应的最大长度")
    parser.add_argument("--question_length", type=int,
                        default=35, help="question 对应的最大长度")
    parser.add_argument("--option_length", type=int,
                        default=30, help="option 对应的最大长度")
